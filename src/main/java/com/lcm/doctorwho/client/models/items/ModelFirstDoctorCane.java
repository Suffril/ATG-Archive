...
public class ModelFirstDoctorCane extends ModelBase implements ItemModelBase {
	...
	public ModelFirstDoctorCane() {
		...
		Handle1.mirror = true;
		ATGUtils.setRotation(Handle1, 0F, 0F, 0F);
		...
		Handle2.mirror = true;
		ATGUtils.setRotation(Handle2, 0F, 0F, 0F);
		...
		Silver1.mirror = true;
		ATGUtils.setRotation(Silver1, 0F, 0F, 0F);
		...
		Silver2.mirror = true;
		ATGUtils.setRotation(Silver2, 0F, 0F, 0F);
		...
		CaneTop.mirror = true;
		ATGUtils.setRotation(CaneTop, 0F, 0F, 0F);
