...
public class ModelTTCapsuleHellbent extends TardisModelOutline {
	...
	public ModelTTCapsuleHellbent() {
		...
		TEX = new ResourceLocation(AcrossTheGalaxy.MODID, "textures/models/tardis/tardis_hellbent.png");
		...
		MS4.mirror = true;
		ATGUtils.setRotation(MS4, 0F, 0F, 0F);
		...
		PO9.mirror = true;
		ATGUtils.setRotation(PO9, 0F, 0F, 0F);
		...
		PO10.mirror = true;
		ATGUtils.setRotation(PO10, 0F, 0F, 0F);
		...
		PO11.mirror = true;
		ATGUtils.setRotation(PO11, 0F, 0F, 0F);
		...
		PO12.mirror = true;
		ATGUtils.setRotation(PO12, 0F, 0F, 0F);
		...
		ATGUtils.setRotation(DoorLeft, 0F, 0F, 0F);
		...
		ATGUtils.setRotation(DoorRight, 0F, 0F, 0F);
		...
		Void1.mirror = true;
		ATGUtils.setRotation(Void1, 0F, 0.7853982F, 0F);
		...
		Void2.mirror = true;
		ATGUtils.setRotation(Void2, 0F, 0F, 0F);
