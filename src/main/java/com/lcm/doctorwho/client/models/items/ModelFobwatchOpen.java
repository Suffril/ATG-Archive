...
public class ModelFobwatchOpen extends ModelBase implements ItemModelBase {
	...
	public ModelFobwatchOpen() {
		...
		ATGUtils.setRotation(WatchFace, 0F, 0F, 0F);
		...
		ATGUtils.setRotation(WatchFaceGold1, 0F, 0F, 0F);
		...
		ATGUtils.setRotation(WatchFaceGold2, 0F, 0F, 0F);
		...
		ATGUtils.setRotation(WatchFaceGold3, 0F, 0F, 0F);
		...
		ATGUtils.setRotation(WatchLatch, 0F, 0F, 0F);
		...
		ATGUtils.setRotation(WatchCoverBack, 0F, 0F, 0F);
		...
		ATGUtils.setRotation(WatchDial, 0F, 0F, 0F);
		...
		ATGUtils.setRotation(WatchDialTop, 0F, 0F, 0F);
		...
		ATGUtils.setRotation(WatchFobBase, 0F, 0F, 0F);
		...
		ATGUtils.setRotation(WatchHandleHold, 0F, 0F, 0F);
		...
		ATGUtils.setRotation(WatchBackIndent1, 0F, 0F, 0F);
		...
		ATGUtils.setRotation(WatchBackIndent2, 0F, 0F, 0F);
