 ...
 * @formatter:off
 */
@Mod.EventBusSubscriber public class TraitDumb extends AbilityConstant implements INegativeTrait {

	public TraitDumb(EntityPlayer player) {
		super(player);
	}

	@SubscribeEvent public static void onExperienceGain(PlayerPickupXpEvent event) {
		...
		for (Ability ability : abilityList)
			if (ability instanceof TraitDumb && ability.isUnlocked())
