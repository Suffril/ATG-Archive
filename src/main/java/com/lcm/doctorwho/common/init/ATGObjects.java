...
public class ATGObjects {
	...
	public static class EntityEntries {
        ...
        public static final EntityEntry weepingAngel = EntityEntryBuilder.create().entity(EntityWeepingAngel.class).factory(world -> new EntityWeepingAngel(world)).id(new ResourceLocation(AcrossTheGalaxy.MODID, "weeping_angel"), 0).name("weeping_angel").tracker(80, 3, false).build();
