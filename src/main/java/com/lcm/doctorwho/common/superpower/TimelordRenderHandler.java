 ...
 */
@Mod.EventBusSubscriber(Side.CLIENT) public class TimelordRenderHandler implements SuperpowerRenderer.ISuperpowerRenderer {
	...
	@Override public void onRenderPlayer(RenderLivingBase<?> renderLivingBase, Minecraft minecraft, EntityPlayer entityPlayer, Superpower superpower, SuperpowerPlayerHandler superpowerPlayerHandler, float v, float v1, float v2, float v3, float v4, float v5, float v6) {
	...
	@SubscribeEvent public static void keyInput(InputUpdateEvent e) {
