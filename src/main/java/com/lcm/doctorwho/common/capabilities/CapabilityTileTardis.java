...
public class CapabilityTileTardis implements ITardisTile {
	@CapabilityInject(ITardisTile.class) public static final Capability<ITardisTile> TARDIS = null;
	...
	@Override public int getTardisID() {
		return tardisID;
	}

	@Override public void setTardisID(int id) {
		tardisID = id;
	}
	...
	@Override public void setModelID(int id) {
		modelID = id;
	}
	...
	@Override public void setOwner(String uuid) {
		ownerUUID = uuid;
	}
	...
	public static class Storage implements Capability.IStorage<ITardisTile> {
		...
		@Nullable @Override public NBTBase writeNBT(Capability<ITardisTile> capability, ITardisTile instance, EnumFacing side) {
			return instance.writeNBT();
		}

		@Override public void readNBT(Capability<ITardisTile> capability, ITardisTile instance, EnumFacing side, NBTBase nbt) {
		}
	}
}
